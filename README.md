...
scp -r ./save_iq_w_tx_file.json npatwari@pc05-fort.emulab.net:/local/repository/etc/cmdfiles/save_iq_w_tx_file.json
scp -r ./save_iq_w_tx_file.json npatwari@pc10-fort.emulab.net:/local/repository/etc/cmdfiles/save_iq_w_tx_file.json
scp -r ./save_iq_w_tx_file.json npatwari@pc11-fort.emulab.net:/local/repository/etc/cmdfiles/save_iq_w_tx_file.json
scp -r ./save_iq_w_tx_file.json npatwari@pc07-fort.emulab.net:/local/repository/etc/cmdfiles/save_iq_w_tx_file.json
scp -r ./QPSK_signal_2024-05-13.iq npatwari@pc05-fort.emulab.net:/local/repository/shout/save_iq_w_tx_file.json
scp -r ./QPSK_signal_2024-05-13.iq npatwari@pc10-fort.emulab.net:/local/repository/shout/save_iq_w_tx_file.json
scp -r ./QPSK_signal_2024-05-13.iq npatwari@pc11-fort.emulab.net:/local/repository/shout/save_iq_w_tx_file.json
scp -r ./QPSK_signal_2024-05-13.iq npatwari@pc07-fort.emulab.net:/local/repository/shout/save_iq_w_tx_file.json
